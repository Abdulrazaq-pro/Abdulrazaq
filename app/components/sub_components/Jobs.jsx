    ...
    return (
      <div>
        <AnimationOnScroll animateIn="animate__fadeIn ">
          <div
            className={`  flex flex-col  rounded-lg  shadow-md  group overflow-hidden hover:opacity-80 relative ${
              color_num === 1 && "shadow-[#3c4acc] "
            } ${color_num === 2 && "shadow-[#2ea85d] "} ${
              color_num === 3 && "shadow-[#191958] "
            }`}
          >
            <div
